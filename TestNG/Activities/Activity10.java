...
public class Activity10 {
    ...
    public static List<List<Object>> readExcel(String filePath) {
        ...
        try {
            ...
            FileInputStream file = new FileInputStream("C:\\Users\\0022E4744\\Desktop\\testing trng\\TestNG\\Activity10.xlsx");
    ...
    public static Object[][] signUpInfo() {
        ...
        List<List<Object>> data = readExcel("C:\\Users\\0022E4744\\Desktop\\testing trng\\TestNG\\Activity10.xlsx");
        return new Object[][] {
                { data.get(1) },
                { data.get(2) },
                { data.get(3) },
